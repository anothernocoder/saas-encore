...
export function Environment(name: string): BaseURL {
    return `https://${name}-dondi-saas-example-sdwi.encr.app`
}
...
/**
 * Client is an API client for the dondi-saas-example-sdwi Encore application.
 */
...
export namespace subscription {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.stripeWebhookHandler = this.stripeWebhookHandler.bind(this)
        }
         ...
         */
        public async stripeWebhookHandler(method: "POST", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "dondi-saas-example-sdwi-Generated-TS-Client (Encore/v1.48.11)";
        }
